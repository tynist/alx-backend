...
class MRUCache(BaseCaching):
    """
    Class that represents a caching system using the MRU (Most Recently Used) algorithm.
    ...
    def put(self, key, item):
        ...
        If the number of items exceeds the maximum limit, the most recently used item will be discarded.
    ...
    def get(self, key):
        ...
        If the key is found, it promotes the key to the most recently used position.
